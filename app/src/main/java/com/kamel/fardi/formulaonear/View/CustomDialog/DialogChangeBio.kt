...
class DialogChangeBio {
    ...
    fun ShowEditBio(context: Context?, view: View) {
        ...
        dialog.show()
        /////////////////////
        btnCancel = view.findViewById(R.id.AnnulerChangeBio)
        btnSave = view.findViewById(R.id.SaveChangeBio)
        txtEdit = view.findViewById(R.id.txtBioChange)
        LayoutEdit = view.findViewById(R.id.txtChangeBioLayout)
        txtcount = view.findViewById(R.id.txtcountChangeBio)
        /////////////////////
        MySharedPref =
        ...
        btnSave.setOnClickListener {
            ...
            if (txtEdit.text.toString() == BIOUSER) {
                txtcount.setText("The Same Bio!!")
            } else {
        ...
        service.EditProfil(map).enqueue(object : Callback<JsonObject> {
            override fun onResponse(
                ...
                if (response.code() == 200) {
                    ...
                    dialog.cancel();
                    ReadyFunction.changeFragment(com.kamel.fardi.formulaonear.View.Fragement.EditProfil(),context,"")
                } else {
