package com.kamel.fardi.formulaonear.ViewModel
...
import com.kamel.fardi.formulaonear.Data.Loginresponse
import com.kamel.fardi.formulaonear.Network.SessionManager
import com.kamel.fardi.formulaonear.Network.UserApi
import com.kamel.fardi.formulaonear.Network.retrofit
import com.kamel.fardi.formulaonear.R
import com.kamel.fardi.formulaonear.Utils.*
import com.kamel.fardi.formulaonear.View.Activity.ForgetPassword2
import com.kamel.fardi.formulaonear.View.Activity.ForgetPassword3
import com.kamel.fardi.formulaonear.View.Activity.Login
import com.kamel.fardi.formulaonear.View.CustomDialog.CustomDialog


class UserViewModel : ViewModel() {
    val retrofi: Retrofit = retrofit.instance
            ...
            override fun onResponse(call: Call<JsonObject>, response: Response<JsonObject>) {
                if (response.isSuccessful) {
                    ...
                    if (response.code() == 202) {
                        CustomToast(context, "Success! You've joined formula AR", "GREEN").show()
                        SendConfirmEmail(txtemail.text.toString()) // Method to send verification email of user needing confirmation
                        ...
                        Handler().postDelayed({
                            ReadyFunction.GoToActivityLogin(context, activity) // Go to login page
                        }, 4500)
                    } else {
                        CustomToast(context, "This Email Already Exists!", "RED").show()
                    }
                } else {
                    CustomToast(context, "Sorry, Something Went Wrong!", "RED").show()
                }
            }
